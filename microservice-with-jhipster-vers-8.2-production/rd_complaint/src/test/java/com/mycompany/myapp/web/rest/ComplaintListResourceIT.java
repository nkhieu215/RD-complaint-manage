...
class ComplaintListResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_PRODUCTION_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L),
            ZoneOffset.UTC);
    ...
    private static final ZonedDateTime DEFAULT_RECTIFICATION_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L),
            ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_RECTIFICATION_TIME = ZonedDateTime.now(ZoneId.systemDefault())
            .withNano(0);
    ...
    private static final String DEFAULT_UNIT_OF_USE = "AAAAAAAAAA";
    private static final String UPDATED_UNIT_OF_USE = "BBBBBBBBBB";
    ...
    public static ComplaintList createEntity(EntityManager em) {
        ComplaintList complaintList = new ComplaintList()
                ...
                .unit_of_use(DEFAULT_UNIT_OF_USE)
    ...
    public static ComplaintList createUpdatedEntity(EntityManager em) {
        ComplaintList complaintList = new ComplaintList()
                ...
                .unit_of_use(UPDATED_UNIT_OF_USE)
    ...
    void createComplaintList() throws Exception {
        ...
        assertComplaintListUpdatableFieldsEquals(returnedComplaintList,
                getPersistedComplaintList(returnedComplaintList));
    }
    ...
    void getAllComplaintLists() throws Exception {
        ...
        restComplaintListMockMvc
                ...
                .andExpect(jsonPath("$.[*].unit_of_use").value(hasItem(DEFAULT_UNIT_OF_USE)))
                .andExpect(jsonPath("$.[*].implementation_result_id")
                        .value(hasItem(DEFAULT_IMPLEMENTATION_RESULT_ID.intValue())))
    ...
    void getComplaintList() throws Exception {
        ...
        restComplaintListMockMvc
                ...
                .andExpect(jsonPath("$.unit_of_use").value(DEFAULT_UNIT_OF_USE))
    ...
    void putExistingComplaintList() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedComplaintList are not
    ...
    void putWithMissingIdPathParamComplaintList() throws Exception {
        ...
        restComplaintListMockMvc
                .perform(
                        put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON)
                                .content(om.writeValueAsBytes(complaintListDTO)))
    ...
    void fullUpdateComplaintListWithPatch() throws Exception {
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertComplaintListUpdatableFieldsEquals(partialUpdatedComplaintList,
                getPersistedComplaintList(partialUpdatedComplaintList));
    }
    ...
    void deleteComplaintList() throws Exception {
        ...
        restComplaintListMockMvc
                .perform(delete(ENTITY_API_URL_ID, complaintList.getId()).with(csrf())
    ...
    protected void assertPersistedComplaintListToMatchUpdatableProperties(ComplaintList expectedComplaintList) {
        assertComplaintListAllUpdatablePropertiesEquals(expectedComplaintList,
                getPersistedComplaintList(expectedComplaintList));
    }
}
