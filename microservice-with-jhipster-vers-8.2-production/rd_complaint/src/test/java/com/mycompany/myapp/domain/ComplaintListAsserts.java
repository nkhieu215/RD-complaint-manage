...
public class ComplaintListAsserts {
    ...
    public static void assertComplaintListUpdatableFieldsEquals(ComplaintList expected, ComplaintList actual) {
        assertThat(expected)
                ...
                .satisfies(e -> assertThat(e.getProduct_code()).as("check product_code")
                        .isEqualTo(actual.getProduct_code()))
                .satisfies(e -> assertThat(e.getProduct_name()).as("check product_name")
                        .isEqualTo(actual.getProduct_name()))
                ...
                .satisfies(e -> assertThat(e.getReflector_id()).as("check reflector_id")
                        .isEqualTo(actual.getReflector_id()))
                .satisfies(e -> assertThat(e.getTotal_errors()).as("check total_errors")
                        .isEqualTo(actual.getTotal_errors()))
                ...
                // )
                .satisfies(e -> assertThat(e.getDapartment_id()).as("check dapartment_id")
                        .isEqualTo(actual.getDapartment_id()))
                .satisfies(
                        e -> assertThat(e.getCheck_by_id()).as("check check_by_id").isEqualTo(actual.getCheck_by_id()))
                .satisfies(
                        e -> assertThat(e.getRectification_time())
                ...
                .satisfies(e -> assertThat(e.getComplaint_detail()).as("check complaint_detail")
                        .isEqualTo(actual.getComplaint_detail()))
                .satisfies(
                        e -> assertThat(e.getUnit_of_use()).as("check unit_of_use").isEqualTo(actual.getUnit_of_use()))
                .satisfies(
                        e -> assertThat(e.getImplementation_result_id())
                ...
                .satisfies(e -> assertThat(e.getFollow_up_comment()).as("check follow_up_comment")
                        .isEqualTo(actual.getFollow_up_comment()))
                .satisfies(e -> assertThat(e.getComplaint_id()).as("check complaint_id")
                        .isEqualTo(actual.getComplaint_id()))
                .satisfies(
                        e -> assertThat(e.getCreated_at())
                                .as("check created_at")
                                .usingComparator(zonedDataTimeSameInstant)
                                .isEqualTo(actual.getCreated_at()))
                .satisfies(
                        e -> assertThat(e.getUpdated_at())
                                .as("check updated_at")
                                .usingComparator(zonedDataTimeSameInstant)
                                .isEqualTo(actual.getUpdated_at()))
                .satisfies(e -> assertThat(e.getSerial()).as("check serial").isEqualTo(actual.getSerial()))
                .satisfies(
                        e -> assertThat(e.getMac_address()).as("check mac_address").isEqualTo(actual.getMac_address()));
    }
