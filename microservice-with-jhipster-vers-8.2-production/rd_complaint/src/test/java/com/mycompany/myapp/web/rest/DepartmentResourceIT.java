...
class DepartmentResourceIT {
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).create_by(UPDATED_CREATE_BY).created_at(UPDATED_CREATED_AT).status(UPDATED_STATUS);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).create_by(UPDATED_CREATE_BY).created_at(UPDATED_CREATED_AT);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).create_by(UPDATED_CREATE_BY).created_at(UPDATED_CREATED_AT).status(UPDATED_STATUS);
