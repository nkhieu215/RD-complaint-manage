...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Complaint}.
 */
@RestController
...
public class ComplaintResource {
    ...
    private static final String ENTITY_NAME = "rdComplaintComplaint";
    ...
    public ResponseEntity<ComplaintDTO> createComplaint(@RequestBody ComplaintDTO complaintDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/complaints/" + complaintDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, complaintDTO.getId().toString()))
            .body(complaintDTO);
    }
